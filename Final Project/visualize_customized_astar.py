...
# 設定與資料讀取
# =============================
costmap_pth = f"./dilated_costmap/scene-0039_pred/29560e3766b241d281b8b85cdcd790e8.png"          # xxxx.png
height_map_pth = f"./road_height_output/scene-0039_pred/29560e3766b241d281b8b85cdcd790e8.npy"     # xxxx.npy

cost_map_full = cv2.imread(costmap_pth, cv2.IMREAD_GRAYSCALE)
height_map_full = np.load(height_map_pth)
